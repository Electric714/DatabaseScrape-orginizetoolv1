...
SOURCE_CATALOG = [
    ...
    {"key": "bbb", "name": "Better Business Bureau", "method": "Published profile sitemaps + direct profile HTML", "status": "Sitemap collector implemented; live validation pending",
     "fields": ["better_business_bureau_complaints"], "hosts": ["bbb.org", "www.bbb.org"],
     "note": "Discovery starts from BBB's robots-advertised business-profile sitemap index and never uses /search. Current POC sitemap ranges cover FL, IL, MN, MO, OH, and WI. Exact profile identity/location is verified before /complaints is read; incomplete or blocked collection remains unknown."},
